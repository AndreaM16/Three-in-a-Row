...
int main (int argc, char *argv[])
{
    ...
    /// Generazione della main window e stampa
        ...
        g_signal_connect(finestra, "destroy", esci, &datas);
    ...
    /// Riempimento verticale
     ...
     /// Generazione sottomenu' con link al menu' file
        ...
        GtkWidget * spacer = gtk_separator_menu_item_new();
        GtkWidget * spacer2 = gtk_separator_menu_item_new();
        GtkWidget * spacer3 = gtk_separator_menu_item_new();
    ...
    /// Collegamento funzioni agli item del menu
        g_signal_connect(G_OBJECT(menu_esci), "activate", G_CALLBACK(esci),&datas);
